    ...
    return (
        <div className='flex flex-col justify-center bg-[#FFDDEE]'>
            <div className='banner w-11/12 mx-auto grid grid-cols-1 md:grid-cols-2 items-center'>
                <div className=''>
                    <h1 className='text-3xl text-grey uppercase tracking-wider leading-10'>Discover <br /><span className='text-primary'>Beauty</span> and <span className='text-primary'>Fashion</span> <br /> for Men and Women</h1>
